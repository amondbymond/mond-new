...
export default function LandingPage() {
  ...
  <div className="flex justify-between items-center w-full max-w-[1200px] mx-auto px-4 py-3 md:px-8 md:py-4">
    ...
    <a
      ...
      className="bg-[#ff8000] hover:bg-[#f59931] text-white font-medium px-3 py-2 text-sm md:px-6 md:py-2 md:text-base rounded-lg whitespace-nowrap"
    >
      서비스 사용하기
    </a>
  </div>
